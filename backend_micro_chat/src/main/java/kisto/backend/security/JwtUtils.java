package kisto.backend.security;
...
public class JwtUtils {
  ...
  public static String generateToken(Authentication usuario) throws JsonProcessingException {
    ...
    Date agora = new Date();
    Long hora = 1000L * 60L * 60L * 720L; // trinta dias
    return Jwts.builder().claim("userDetails", usuarioJson).setIssuer("kisto").setSubject(usuario.getName())
